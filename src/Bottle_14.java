...
public class Bottle_14 {
    int capacity;
    int waterVolume;

    public Bottle_14(int capacity, int waterVolume) {
    ...
    public void pourAll(Bottle_14 b) {
    ...
    // เทน้ำจากขวดนี้ ไปยังขวด b จนกว่าขวด b จะเต็ม
    public void pourUntilFull(Bottle_14 b) {
